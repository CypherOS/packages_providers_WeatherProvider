...
public class WeatherChannelApi implements LocationListener {
    ...
    WeatherProvider getResult() {
        ...
        if (DEBUG) Log.d(TAG, "latitude=" + mLastLocation.getLatitude() + ",longitude=" + mLastLocation.getLongitude());
        ...
        try {
            Response response = httpClient.newCall(new Request.Builder()
                    ...
                    .url("https://weather.com/weather/today/l/" + mLastLocation.getLatitude() + "," + mLastLocation.getLongitude() + "?par=google")
                    .build()).execute();
            if (response.body() != null && response.isSuccessful()) {
                mSunCondition = getSunCondition(mLastLocation.getLatitude(), mLastLocation.getLongitude());
				...
				Log.d(TAG, "Weather update successful");
    ...
    void queryLocation() {
		...
		mLocationManager.requestLocationUpdates(null, sInstance, Looper.getMainLooper());
        ...
        if (mLocationManager.getLastLocation() == null) {
            if (mLocationManager.isProviderEnabled(LocationManager.NETWORK_PROVIDER)) {
                mLocationManager.requestSingleUpdate(
                        LocationManager.NETWORK_PROVIDER, sInstance, Looper.getMainLooper());
            } else if (mLocationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
                mLocationManager.requestSingleUpdate(
                        LocationManager.GPS_PROVIDER, sInstance, Looper.getMainLooper());
            }
        }
    ...
    public void onLocationChanged(Location location) {
		synchronized (WeatherChannelApi.class) {
			if (location != null
